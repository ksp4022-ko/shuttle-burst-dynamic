...
export const previewDefaults: PreviewControls = {
  ...
  activeInfoRegisteredX: 9,
  activeInfoRegisteredY: 33,
  activeInfoRegisteredScale: 1.97,
  activeInfoRegisteredRotation: 7,
  activeInfoNeededShow: true,
  activeInfoNeededX: 19,
  activeInfoNeededY: 36,
  activeInfoNeededScale: 1.88,
  activeInfoNeededRotation: 6,
  activeInfoWaitlistShow: true,
  activeInfoWaitlistX: 34,
  ...
  activeIdentityStatusMarkX: 31,
  activeIdentityStatusMarkY: 45,
  ...
  activeIdentityNameZIndex: 1,
  activeIdentityNameFontSize: 18,
  activeIdentityNameMaxWidth: 130,
  ...
  activeIdentityHelperCancelX: 45,
  activeIdentityHelperCancelY: 65,
